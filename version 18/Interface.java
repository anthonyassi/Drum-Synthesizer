  ...
  static void buildSampler(Container pane){
   ...
   //if buildSampler is called from Actions class then creat new channel
    if(numPanels>1){
      ...
      samplers[0].add(samplers[i].volumeSlider, "gapleft 60, h 76!");
      samplers[0].add(samplers[i].pitchSlider,"gapleft 20, h 76!");
      samplers[0].add(samplers[i].lowCutoffSlider, "gapleft 20, h 76!");
      samplers[0].add(samplers[i].highCutoffSlider, "gapleft 20, h 76!");
  ...
  static void buildSynthesizer(Container pane){
   //if buildSYNTH is called from Actions class then creat new channel
    if(numPanels>1){
      ...
      samplers[0].add(synthesizers[i].volumeSlider, "gapleft 52, h 76!");
      samplers[0].add(synthesizers[i].pitchSlider, "gapleft 20, h 76!");
      samplers[0].add(synthesizers[i].lowCutoffSlider, "gapleft 20, h 76!");
      samplers[0].add(synthesizers[i].highCutoffSlider, "gapleft 20, h 76!");
      samplers[0].add(synthesizers[i].attackSlider, "gapleft 20, h 76!");
      samplers[0].add(synthesizers[i].sustainSlider, "gapleft 20, h 76!");
      samplers[0].add(synthesizers[i].releaseSlider, "gapleft 20, h 76!");
