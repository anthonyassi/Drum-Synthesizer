  ...
  String cmd = e.getActionCommand();
   ...
   //if user hits play button
    if(cmd.contains("PLAY")){
      ...
      p.play(synthesizers[numSynthesizer].volumeSlider.getValue(), synthesizers[numSynthesizer].pitchSlider.getValue(),synthesizers[numSynthesizer].cutoffSlider.getValue() );
    }
